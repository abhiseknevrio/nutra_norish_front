        ...
        <section className='howItWorkSec'>
            ...
            <div className='hidden md:block'>
                <div className='grid md:grid-cols-3 py-16'>
                    ...
                    <div className='flex justify-center items-center relative'>
                        <img src="https://cdn.shopify.com/s/files/1/0606/0703/7648/files/longline.svg" alt="" srcSet="" className='absolute lineCss' />
            ...
            <div className='block md:hidden'>
                <div className='grid grid-cols-2 py-8'>
                    <div className='flex justify-center items-center relative'>
                        <img src="https://cdn.shopify.com/s/files/1/0606/0703/7648/files/line.svg" alt="" srcSet="" className='absolute lineCss' />
